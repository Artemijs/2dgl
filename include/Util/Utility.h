...
public:
	...
	static void DrawSpriteManually(const Matrix4x4& matrix, const BaseMaterial* bm);
	static void DrawSpriteManually(const Vec3& pos, const Vec3& scale, const BaseMaterial* bm);
