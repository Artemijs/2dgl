...
Button::Button() : UIsprite("Assets/Textures/btn.png", Vec3( 0,0,0), Vec3(50,50,1), 0), 
...
Button::Button(const char* text, Vec3 pos, Vec3 size, float ang): UIsprite("Assets/Textures/btn.png", pos, size, ang),
MouseEvent(new BoxBounds(
